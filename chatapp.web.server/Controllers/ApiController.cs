...
namespace chatapp.web.server.Controllers
{
    ...
    public class ApiController : Controller
    {
        ...
        protected ChatAppEmailSender mChatAppEmailSender;

        #endregion

        public IConfiguration Configuration { get; }

        public ApiController(IConfiguration configuration, ChatAppEmailSender chatAppEmailSender)
        {
            Configuration = configuration;
            mChatAppEmailSender = chatAppEmailSender;
        }
        ...
        public async Task<ApiResponse<RegisterResultApiModel>> RegisterAsync([FromBody]RegisterCredentialsApiModel registerCredentials)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await mChatAppEmailSender.SendUserVerificationEmailAsync(user.UserName, userIdentity.Email, confirmationUrl);
